...
class AiBot:
    def __init__(self):
        ...
        self.dp.message.register(cmd_start, Command("start", prefix="!"))
        self.dp.message.register(cmd_start, Command("start"))
        self.dp.message.register(cmd_help, Command("help", prefix="!"))
        self.dp.message.register(cmd_help, Command("help"))
        self.dp.message.register(cmd_restart, Command("restart", prefix="!"))
        ...
        self.dp.message.register(partial(cmd_ai_document, client=self.client, bot=self.bot), ai_file)
